...
\begin{tikzpicture}[
  ...
  \draw[phonon] (1.3,0) .. controls (1.3,3.0) and (6.7,3.0) .. (6.7,0);
  \draw[phonon] (3.1,0) .. controls (3.1,1.32) and (4.9,1.32) .. (4.9,0);
  \node at (4,2.57) {$\mathbf q_1$};
  \node at (4,1.30) {$\mathbf q_2$};
